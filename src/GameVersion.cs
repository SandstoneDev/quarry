...
{
    public const string Version = "v1005";  // release tag; bump per release (see RELEASE_PLAYBOOK). UpdateChecker string-compares this to the latest GitHub release tag.
