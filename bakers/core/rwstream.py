...
ANIM_DATABASE = 0x17          # rwID_ANIMDATABASE
IMAGE = 0x18                  # rwID_IMAGE, RwImage non-native
SKIN_ANIMATION = 0x19         # rwID_SKINANIMATION, legacy skin anim
GEOMETRY_LIST = 0x1A
# 0x1B is HANIMANIMATION (RtAnimAnimation) - the SDK name.
HANIM_ANIMATION = 0x1B
DMORPH_ANIMATION = 0x1E       # rwID_DMORPHANIMATION - NOT an alias of 0x1F
RIGHT_TO_RENDER = 0x1F
MT_EFFECT_NATIVE = 0x20       # rwID_MTEFFECTNATIVE
MT_EFFECT_DICT = 0x21         # rwID_MTEFFECTDICT
PI_TEXTURE_DICTIONARY = 0x23  # rwID_PITEXDICTIONARY
TOC = 0x24                    # rwID_TOC
PRT_STD_GLOBAL_DATA = 0x25    # rwID_PRTSTDGLOBALDATA
# --- plugin/extension ids (MAKECHUNKID vendor=1 -> 0x01xx) ---
MORPH_PLG = 0x0105            # rwID_MORPHPLUGIN
MRM_PLG = 0x0111             # rwID_MRMPLUGIN, multi-res LOD mesh
COLLIS_PLG = 0x011D          # rwID_COLLISPLUGIN, RW-native collision
SKIN_PLG = 0x0116            # rwID_SKINPLUGIN
HANIM_PLG = 0x011E           # rwID_HANIMPLUGIN
USER_DATA_PLG = 0x011F       # rwID_USERDATAPLUGIN
MATERIAL_EFFECTS_PLG = 0x0120  # rwID_MATERIALEFFECTSPLUGIN
NORMAL_MAP_PLG = 0x0133      # rwID_NORMMAPPLUGIN
ADC_PLG = 0x0134             # rwID_ADCPLUGIN, PS2 tri-strip adjacency
# --- vendor=5 -> 0x05xx ---
BIN_MESH_PLG = 0x050E
